...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody @Validated CreateUserRequestBody userRequestBody, BindingResult bindingResult){
    ...
    public String login(@RequestBody @Validated LoginUserRequestBody userRequestBody, BindingResult bindingResult){
        if(bindingResult.hasErrors()){
