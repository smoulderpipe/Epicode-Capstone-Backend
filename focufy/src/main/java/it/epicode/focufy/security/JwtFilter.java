...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        boolean shouldNotFilter = new AntPathMatcher().match("/auth/**", request.getServletPath());
        //System.out.println("Should not filter: " + shouldNotFilter + " for path: " + request.getServletPath());
